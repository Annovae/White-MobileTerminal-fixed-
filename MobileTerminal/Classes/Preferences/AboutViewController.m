...
-(IBAction)tweetbutton:(id)sender
    {
        ...
        [tweet setInitialText:@"iOS7 White Terminal is cool & awesome!! Don`t you wanna try it? :)\nPlease visit my repository. http://simplecake.tk/apt"];
...
-(void)awakeFromNib
{
    ...
    versionLabel.text = [NSString stringWithFormat:@"W7.%d", settings.svnVersion];
}
